package nepjr.nfmod.gregtech.capabilities;
...
public class NFMultiblockRecipeLogic extends MultiblockRecipeLogic {

	public NFMultiblockRecipeLogic(RecipeMapMultiblockController tileEntity) {
        super(tileEntity);
    }

    public NFMultiblockRecipeLogic(RecipeMapMultiblockController tileEntity, boolean hasPerfectOC) {
