...
public class AdvancedAL extends GCYMRecipeMapMultiblockController {
    ...
    public AdvancedAL(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, RecipeMaps.ASSEMBLY_LINE_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new AdvancedAL(metaTileEntityId);
    }
