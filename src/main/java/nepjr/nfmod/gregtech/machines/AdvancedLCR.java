...
import nepjr.nfmod.gregtech.capabilities.NFMultiblockRecipeLogic;
...
public class AdvancedLCR extends GCYMRecipeMapMultiblockController {

    public AdvancedLCR(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, new RecipeMap[] { RecipeMaps.LARGE_CHEMICAL_RECIPES });
        this.recipeMapWorkable = new NFMultiblockRecipeLogic(this, true);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new AdvancedLCR(metaTileEntityId);
    }
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        MultiblockShapeInfo.Builder baseBuilder = MultiblockShapeInfo.builder()
                .where('S', NFMetaTileEntities.ADVANCED_LCR, EnumFacing.SOUTH)
