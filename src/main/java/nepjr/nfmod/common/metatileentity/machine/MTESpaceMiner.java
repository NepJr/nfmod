package nepjr.nfmod.common.metatileentity.machine;
...
import nepjr.nfmod.api.capability.impl.miner.SpaceMinerLogic;
...
public class MTESpaceMiner extends TieredMetaTileEntity implements ISpaceMiner, IControllable, IDataInfoProvider {
    ...
    private final SpaceMinerLogic minerLogic;

    public MTESpaceMiner(ResourceLocation metaTileEntityId, int tier, int speed, int maximumRadius, int fortune) {
        super(metaTileEntityId, tier);
        this.inventorySize = 4;
        this.energyPerTick = GTValues.V[tier - 1];
        this.minerLogic = new SpaceMinerLogic(this, fortune, speed, maximumRadius, Textures.SOLID_STEEL_CASING);
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MTESpaceMiner(metaTileEntityId, getTier(), this.minerLogic.getSpeed(),
