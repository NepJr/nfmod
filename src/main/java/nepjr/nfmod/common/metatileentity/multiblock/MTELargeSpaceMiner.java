package nepjr.nfmod.common.metatileentity.multiblock;
...
import nepjr.nfmod.api.capability.impl.miner.MultiblockSpaceMinerLogic;
...
public class MTELargeSpaceMiner extends MultiblockWithDisplayBase
        implements ISpaceMiner, IControllable, IDataInfoProvider {
    ...
    private final MultiblockSpaceMinerLogic minerLogic;

    public MTELargeSpaceMiner(ResourceLocation metaTileEntityId, int tier, int speed, int maximumChunkDiameter,
                              int fortune, Material material, int drillingFluidConsumePerTick) {
        super(metaTileEntityId);
        this.material = material;
        this.tier = tier;
        this.drillingFluidConsumePerTick = drillingFluidConsumePerTick;
        this.minerLogic = new MultiblockSpaceMinerLogic(this, fortune, speed, maximumChunkDiameter * CHUNK_LENGTH / 2,
                RecipeMaps.MACERATOR_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MTELargeSpaceMiner(metaTileEntityId, this.tier, this.minerLogic.getSpeed(),
