...
public class MultiblockSpaceMinerLogic extends SpaceMinerLogic
{
     ...
     */
    public MultiblockSpaceMinerLogic(MetaTileEntity metaTileEntity, int fortune, int speed, int maximumRadius,
